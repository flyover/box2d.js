...
box2d.Testbed.DrawingParticles = function(canvas, settings) {
  ...
  box2d.Testbed.TestMain.SetParticleParameters(box2d.Testbed.DrawingParticles.k_paramDef, box2d.Testbed.DrawingParticles.k_paramDefCount);
...
box2d.Testbed.DrawingParticles.prototype.Keyboard = function(key) {
  ...
  box2d.Testbed.TestMain.SetParticleParameterValue(this.DetermineParticleParameter());
}
