...
box2d.Testbed.SpecialParticleTracker.prototype.SayGoodbyeParticle = function (particleSystem, index)
{
	...
	this.m_particles = this.m_particles.filter(function (value) { return value.GetIndex() !== index; });
...
box2d.Testbed.Sandbox.prototype.__ctor__ = function ()
{
	...
	box2d.Testbed.TestMain.SetParticleParameters(box2d.Testbed.Sandbox.k_paramDef, box2d.Testbed.Sandbox.k_paramDefCount);
	this.m_particleFlags = box2d.Testbed.TestMain.GetParticleParameterValue();
...
box2d.Testbed.Sandbox.prototype.Keyboard = function (key)
{
	...
	box2d.Testbed.TestMain.SetParticleParameterValue(this.m_particleFlags);
}
