...
f=b.GetAngle();goog.global.console.log(e.x.toFixed(2),e.y.toFixed(2),f.toFixed(2))}return 0};goog.exportSymbol("box2d.HelloWorld.main",box2d.HelloWorld.main);

//# sourceMappingURL=/box2d.js/Box2D/Build/HelloWorld/box2d-helloworld.map.json
